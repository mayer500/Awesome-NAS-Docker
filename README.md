...
| 4EVERLAND            | 免费部署Hexo博客，提供存储和加速 | [点我查看](https://hosting.4everland.org)                    | [查看教程](https://zhuanlan.zhihu.com/p/1888537055199482941) | 由于引用文本中的<\|地址\|>不是github链接，因此不返回任何内容。 | 由于提供的<\|地址\|>不是github链接，因此不返回任何内容。     |
...
| Standard Notes       | 实现数据加密存储与安全共享       | [点我查看](https://github.com/standardnotes)                 | [查看教程](https://zhuanlan.zhihu.com/p/1888553173351899370) | ![Star](https://img.shields.io/github/stars/standardnotes/?&label=) | ![Last Commit](https://img.shields.io/github/last-commit/standardnotes?label) |
...
| Open WebUI+Ollama    | 用Docker部署本地AI聊天室         | [点我查看](https://github.com/open-webui/open-webui)         | [查看教程](https://zhuanlan.zhihu.com/p/32684561317)         | ![Star](https://img.shields.io/github/stars/open-webui/open-webui?&label=) ![Star](https://img.shields.io/github/stars/ollama/ollama?&label=) ![Star](https://img.shields.io/github/stars/open-webui/open-webui?&label=) ![Star](https://img.shields.io/github/stars/ollama/ollama?&label=) | ![Last Commit](https://img.shields.io/github/last-commit/open-webui/open-webui?label) ![Last Commit](https://img.shields.io/github/last-commit/ollama/ollama?label) ![Last Commit](https://img.shields.io/github/last-commit/open-webui/open-webui?label) ![Last Commit](https://img.shields.io/github/last-commit/ollama/ollama?label) |
| Homer                | 整合服务打造高颜值导航页         | [点我查看](https://github.com/bastienwirtz/homer)            | [查看教程](https://zhuanlan.zhihu.com/p/32483617466)         | ![Star](https://img.shields.io/github/stars/bastienwirtz/homer?&label=) | ![Last Commit](https://img.shields.io/github/last-commit/bastienwirtz/homer?label) |
